...
public class CompositeCart {
	...
	public CompositeCart(int cartNum, String productCode, String customerId, String jacketCode, String pantsCode,
			int productCount, int productNum, int productListNum, String productName, int productCost, int productPrice,
